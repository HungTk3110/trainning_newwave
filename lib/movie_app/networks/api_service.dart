...
class ApiService {
  ...
  static Future<Autogenerated> fetchAutogenerated(int id) async{

    String urlDetail = "https://api.themoviedb"
        ".org/3/movie/$id/credits?api_key=9bb89316d8693b06d7a84980b29c011f&page=1";

    final apiResponse = await http.get(Uri.parse(urlDetail));
    if (apiResponse.statusCode == 200) {
      return Autogenerated.fromJson(jsonDecode(apiResponse.body));
    } else {
      throw Exception('Failed to load album');
    }
  }
