...
import 'package:training_newwave/movie_app/blocpattern/movie_bloc.dart';
...
class MovieHomeBlocPattern extends StatefulWidget {
  const MovieHomeBlocPattern({Key key}) : super(key: key);

  @override
  State<MovieHomeBlocPattern> createState() => _Movie_HomeState();
}

// ignore: camel_case_types
class _Movie_HomeState extends State<MovieHomeBlocPattern> {
  int currentPosTop = 0;
