...
List<MovieEntity> listMovies = [
  MovieEntity(
    ...
    describe:
        "Thor hẳn là siêu anh hùng Marvel không thể thiếu trong danh sách những nhân vật "
  ...
  MovieEntity(
    ...
    describe:
        "Nội dung phim xoay quanh Stephen Strange - một bác sĩ giải phẫu thần kinh hàng "
  ...
  MovieEntity(
    ...
    describe:
        "Khi xem phim, bạn có thể thấy Captain America là một nhân vật đạt được các chức "
