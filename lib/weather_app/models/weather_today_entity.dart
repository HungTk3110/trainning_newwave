...
String weatherToDayToJson(WeatherToday data) => json.encode(data.toJson());
...
class ListElement {
  ...
  factory ListElement.fromJson(Map<String, dynamic> json) => ListElement(
        ...
        weather: List<WeatherTime>.from(
            json["weather"].map((x) => WeatherTime.fromJson(x))),
...
enum Description { MODERATE_RAIN, LIGHT_RAIN, OVERCAST_CLOUDS }
