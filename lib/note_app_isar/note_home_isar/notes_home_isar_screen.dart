...
class _NoteHomeIsarScreenState extends State<NoteHomeIsarScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _buttonAddNoteWidget(),
    );
  }

  Widget _buttonAddNoteWidget() {
    return Padding(
  ...
  Widget _listNoteHomeWidget({
    required List<NoteIsarEntity> listNote,
  }) {
            ...
            child: InkWell(
              onTap: () async {
                final result = await Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        NotesEditIsarScreen(id: listNote[index].id),
                  ),
                );
                if (result == true) {
                  _noteCubit.getAllNote();
